...
mu=2 # For FedProx
beta=50.0 # For FedMAX
learning_rate=0.01

declare -a experiment_configs=(
# experiment | run | data_iid
  "42 1 false " # Experiment 6, Run 1, Non-IID
  "42 2 false " # Experiment 6, Run 1, Non-IID
  "42 3 false " # Experiment 6, Run 1, Non-IID
)

#### BIG on MC1
declare -a devices_configs=(
# hw_type | host | port | cuda_name | local_epochs | learning_rate
  "rpi sld-rpi-13.ece.utexas.edu 9090 cpu 1 0.01"
  "mc1 sld-mc1-13.ece.utexas.edu 9090 cpu 2 0.005"
)
############### TODO END CHANGE
