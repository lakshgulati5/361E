...
############### TODO CHANGE
cloud_ip="172.29.204.169" #Change every time when new VPN is connected

model_name="lenet5_slim"
loss_func_name="cross_entropy"
loss_type="fedmax" # change to fedmax or fedprox
mu=5 # For FedProx
beta=20.0 # For FedMAX
learning_rate=0.01

declare -a experiment_configs=(
# experiment | run | data_iid
  "44 1 false " # Experiment 6, Run 1, Non-IID
  "44 2 false " # Experiment 6, Run 1, Non-IID
  "44 3 false " # Experiment 6, Run 1, Non-IID
)

#### Little on MC1
declare -a devices_configs=(
# hw_type | host | port | cuda_name | local_epochs | learning_rate
  "rpi sld-rpi-13.ece.utexas.edu 9090 cpu 1 0.0095"
  "mc1 sld-mc1-13.ece.utexas.edu 9090 cpu 1 0.0095"
)
############### TODO END CHANGE
