...
class Cloud:
    ...
    def federated_learning(self):
        ...
        loss_test, acc_test = test(model=net_glob, loss_func=loss_func, cuda_name=cloud_cuda_name, verbose=verbose,
                                   seed=seed, loss_type=loss_type, resize=resize)
        ...
        for comm_round in range(1,comm_rounds+1):
            ...
            for idx, i in enumerate(range(num_devices)):
                ...
                dev_learning_rate = dev["learning_rate"]
                ...
                data = f"{comm_round};{dev_model_name};{dev_model_filename};{local_epochs};{dev_learning_rate};{loss_name};{loss_type};{mu};{beta}"
