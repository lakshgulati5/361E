...
############### TODO CHANGE
cloud_ip="172.29.203.145" #Change every time when new VPN is connected
...
# experiment | run | data_iid
  # "3 1 false" # Experiment 3, Run 1, Non-IID
  # "4 1 false " # Experiment 4, Run 1, Non-IID
  # "5 1 false " # Experiment 5, Run 1, Non-IID
  "8 1 false " # Experiment 6, Run 1, Non-IID
)

declare -a devices_configs=(
# hw_type | host | port | cuda_name | local_epochs
  "rpi sld-rpi-13.ece.utexas.edu 9090 cpu 1"
